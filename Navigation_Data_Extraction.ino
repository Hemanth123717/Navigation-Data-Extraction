...
// // void loop() {
// //   // This loop continuously sends messages to the Bluetooth terminal app

// //   // Check if data is available on Serial1 (Bluetooth)
// //   // Serial1.println(" cm, Left Distance: ");
...
// void displayData(long motorElapsedTime) {
//     Map *temp = head;
//     while (temp != NULL) {
//         Serial1.print("Distance: ");
//         Serial1.print(temp->forwardDis);
